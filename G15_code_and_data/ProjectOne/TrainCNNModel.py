...
def cnn_train_model(train_data,train_label,class_weights):
        ...
        for train,validation in kfold.split(train_data,train_label):
                print("len(train_data[train]):  ", len(train_data[train]))
                ...
                h = model.fit(
                                train_generator,
                                #steps_per_epoch=len(train_data[train]) // batch_size,
                                epochs=epochs,
                ...
                vc_scores = model.evaluate(x=validation_generator)
                ...
                train_acc_scores.append(h.history["accuracy"])
                val_acc_scores.append(h.history["val_accuracy"])
